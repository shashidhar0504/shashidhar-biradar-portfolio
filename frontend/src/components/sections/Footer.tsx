...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-slate-950 text-slate-300 border-t border-slate-800 py-12 px-6 lg:px-12">
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-12 border-b border-slate-800 items-start">
          {/* Left Brand Column */}
          <div className="md:col-span-6 space-y-4">
            <a href="#hero" className="flex items-center gap-2.5">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-orange-600 font-mono font-bold text-white shadow-md shadow-orange-500/20">
                SB
              </div>
              <div>
                ...
                <span className="block text-xs font-mono text-orange-400">
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <ul className="space-y-2 text-xs font-mono">
              ...
              <li>
                <a href="#ai-automation" className="hover:text-orange-400 transition-colors">
                  AI & Automation
                </a>
              </li>
              <li>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono">
          ...
          <p className="text-slate-400">Build. Automate. Solve.</p>

          <button
            onClick={scrollToTop}
            className="flex items-center gap-1.5 rounded-xl border border-slate-800 bg-slate-900 px-3 py-1.5 text-slate-200 hover:text-white hover:border-orange-500 transition-colors"
