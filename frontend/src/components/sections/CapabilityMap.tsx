      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="text-center space-y-3 mb-16">
          ...
          <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-900 tracking-tight">
            Technical <span className="gradient-text">Capability Map</span>
          </h2>
          <p className="text-sm sm:text-base text-slate-600 max-w-2xl mx-auto">
            Comprehensive technical depth across enterprise Java backends, modern React UIs, intelligent AI workflows, automated integrations, and cloud deployments.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                ...
                >
                  <div className="flex items-center gap-3.5">
                    <div
                      className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-xl transition-colors ${
                        isSelected ? "bg-orange-600 text-white shadow-sm" : "bg-white border border-slate-200 text-orange-600 group-hover:bg-orange-50"
                      }`}
                    >
                      <Icon className="h-5 w-5" />
                    </div>
                    <div>
                      <h3 className={`font-heading text-sm font-bold ${isSelected ? "text-orange-700" : "text-slate-800"}`}>
                        {cap.title}
                      </h3>
                  ...
                  <ChevronRight
                    className={`h-5 w-5 transition-transform ${
                      isSelected ? "text-orange-600 translate-x-1" : "text-slate-400 group-hover:text-slate-600"
                    }`}
                  />
                </button>
              );
          ...
          {/* Right Side: Selected Capability Detail */}
            ...
            <div className="h-full glass-panel rounded-3xl p-6 sm:p-8 flex flex-col justify-between border border-slate-200 shadow-xl bg-white">
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4 border-b border-slate-100 pb-6">
                  <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-orange-600 text-white shadow-glow-orange">
                    <SelectedIcon className="h-7 w-7" />
                  </div>
                  <div>
                    <span className="font-mono text-xs text-orange-600 font-bold uppercase tracking-wider">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2.5">
                    {selectedCap.technologies.map((tech, i) => (
                      <div
                        key={i}
                        className="flex items-center gap-2 rounded-xl bg-orange-50/70 border border-orange-200/80 px-3.5 py-2 font-mono text-xs font-semibold text-orange-800 hover:border-orange-300 transition-colors"
                      >
              ...
              <div className="mt-8 rounded-2xl bg-slate-50 p-4 border border-slate-200 text-xs text-slate-600 flex items-center justify-between">
                ...
                <a href="#projects" className="text-orange-600 hover:underline font-heading font-semibold flex items-center gap-1">
